...
// Declare the kernel
__global__ void sortRowsKernelInt(int **matrix, int rows, int col);

__global__ void sortRowsKernelFloat(float **matrix, int rows, int col);

__global__ void sortRowsKernelDouble(double **matrix, int rows, int col);
